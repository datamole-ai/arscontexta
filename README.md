...
Install [Claude Code](https://docs.anthropic.com/en/docs/claude-code) v2.1.129 or newer, [uv](https://docs.astral.sh/uv/), [qmd](https://github.com/tobi/qmd) v2+, Obsidian, and the Obsidian CLI. Then create an empty directory and start Claude Code with a pinned release:
