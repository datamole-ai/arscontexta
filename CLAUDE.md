...
- Root `pyproject.toml` owns the product version. Release preparation mirrors it into the plugin and marketplace metadata, `template/.second-brain`, and `vault-tooling/pyproject.toml`.
